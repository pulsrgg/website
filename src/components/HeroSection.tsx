...
import overlayScreenshot from "@/assets/overlay-screenshot.png";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/5 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-primary">Twitch Extension</span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg font-rajdhani">
                Display live League of Legends game stats directly on your Twitch stream. 
                Show your viewers KDA, items, and team composition in real-time.
              </p>
            </div>
            ...
            <div className="flex gap-8 pt-4">
              <div className="text-center">
                <div className="font-orbitron text-2xl font-bold text-primary">Free</div>
                <div className="text-sm text-muted-foreground">To Use</div>
              </div>
              <div className="w-px bg-primary/20" />
              <div className="text-center">
                <div className="font-orbitron text-2xl font-bold text-primary">Live</div>
                <div className="text-sm text-muted-foreground">Data Sync</div>
              </div>
              <div className="w-px bg-primary/20" />
              <div className="text-center">
                <div className="font-orbitron text-2xl font-bold text-primary">Easy</div>
            ...
            <div className="relative floating">
              ...
              <div className="relative bg-card/80 rounded-xl border border-primary/30 p-2 glow-border backdrop-blur-sm">
                ...
                <img
                  ...
                  alt="LOLLIVE overlay showing real-time game stats"
